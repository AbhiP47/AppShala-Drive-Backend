package com.appShala.userGroupService.listner;
...
@Component
@Slf4j
public class UserDeletedEventListner {

    private final MembershipRepository membershipRepository;

    public UserDeletedEventListner(MembershipRepository membershipRepository)
    {
